<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@swenkerorg/nobis-dolores-quae">
    <img src="https://travis-ci.com/jsx-eslint/@swenkerorg/nobis-dolores-quae.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@swenkerorg/nobis-dolores-quae">
    <img src="https://img.shields.io/npm/v/@swenkerorg/nobis-dolores-quae.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/swenkerorg/nobis-dolores-quae/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@swenkerorg/nobis-dolores-quae.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@swenkerorg/nobis-dolores-quae?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@swenkerorg/nobis-dolores-quae/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@swenkerorg/nobis-dolores-quae'>
    <img src='https://img.shields.io/npm/dt/@swenkerorg/nobis-dolores-quae.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@swenkerorg/nobis-dolores-quae?utm_source=npm-@swenkerorg/nobis-dolores-quae&utm_medium=referral&utm_campaign=readme'>Get professional support for @swenkerorg/nobis-dolores-quae on Tidelift</a>

# @swenkerorg/nobis-dolores-quae

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@swenkerorg/nobis-dolores-quae/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@swenkerorg/nobis-dolores-quae/blob/HEAD/translations/README.mx.md)
...
Next, install `@swenkerorg/nobis-dolores-quae`:

```sh
# npm
npm install @swenkerorg/nobis-dolores-quae --save-dev

# yarn
yarn add @swenkerorg/nobis-dolores-quae --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@swenkerorg/nobis-dolores-quae` globally.
...
@swenkerorg/nobis-dolores-quae is licensed under the [MIT License](LICENSE.md).
